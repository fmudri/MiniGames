    ...
    while (play)
    {
        ...
        */
        ...
        if (key == ConsoleKey.Spacebar)
        {
            ...
            $"\nPress z if you wish to Hit, Enter if you wish to Stand or Esc if Mama raised a quitter\n");

            // Check if the player has already drawn a third card
            if (key == ConsoleKey.Z)
            {
                ...
                + "\nPress Enter to Stand or Space to draw");
            }
